...
A `LICENSE-langgraph` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph), Copyright
2024 LangChain, Inc, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../langgraph-port/specs/SPEC-001-langgraph.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
